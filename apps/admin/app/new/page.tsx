...
export default function NewArticlePage() {
  ...
  const uploadToSupabase = async (file: File, slug: string) => {
    ...
    const {
      data: { publicUrl },
    } = supabase.storage.from("images").getPublicUrl("covers/" + fileName);
  ...
  const handleSave = async (asDraft?: boolean) => {
    ...
    try {
      ...
      if (fileToUpload) {
        const publicUrl = await uploadToSupabase(fileToUpload, form.slug);
      ...
      toast.success(asDraft ? "Saved as draft!" : "Article created!");
